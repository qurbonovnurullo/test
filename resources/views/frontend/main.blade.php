    ...
    <header>
        @if ($client == null)
            ...
            <marquee behavior="" direction="">
                <h3>
                    You did not login. If you do not login, other windows will not open. Please log in.</h3>
            </marquee>
        @endif
            ...
            <div class="container custom-container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-xl-3 col-lg-4 d-none d-lg-block">
                        <div class="logo">
                            <a href="{{ route('main.page') }}"><img src="{{ $settings->site_logo }}"width="300px" alt=""></a>
                        </div>
                    </div>
                        ...
                        <div class="menu-wrap">
                            <nav class="menu-nav show">
                                ...
                                <div class="header-action d-none d-md-block">
                                    <ul>
                                        <li class="shipping-offer"><span></span></li>
                                                            ...
                                                            <form action="/shop" method="GET">
                                                                <div class="col-md-12 mt-3">
                                                                        <input class="form-control " type="text" name="query"
                                                                            ...
                                                                            {{-- <button class="form-controll" type="submit">Search</button> --}}
                                                                </div>
                    ...
                    @foreach ($ads as $item)
                        <div class="col">
                            <div class="insta-post-item">
                                <a href="https://t.me/ll77ll_web_devoloper_01" target="_blank">
                        ...
                        <div class="footer-link-wrap">
                            ...
                            <div class="footer-social">
                                <ul>
                                    ...
                                    <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                                    <li><a href=""><i class="fab fa-youtube"></i></a></li>
                                    <li><a href="https://instagram/abrorbekqodirov963" target="_blank"><i
