                    ...
                    <div class="sidebar-textwidget">
                        <div class="sidebar-info-contents">
                            <div class="content-inner">
                                ...
                                <div class="oc-social">
                                    <ul>
                                        <li><a href="https://t.me/ll77ll_web_devoloper_01"><i class="fab fa-telegram"></i></a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        <div class="shop-details-content">
                            ...
                            <form action="{{ route('add.cart') }}" method="POST" class="rating">
                                @csrf
                                ...
                                <div class="price">
                                    {{ $products->price - $products->price * ($products->discount / 100) }}</div>
